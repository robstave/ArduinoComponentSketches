...
/**
 * ACS-85-0320
 * ATTiny85 Divide by 3,5,7,9
 *
 * Divide the clock signal by 3, 5, 7 ,9 across the 4 output pins.
 *
 * 
 * We will put an interrupt procedure on that to count clock
 * cycles and output digital writes to do divide by 3,5, 7 and 9.
 ...
 * External pin 2 (PB3) = Divide 7
 * External pin 3 (PB4) = Divide 9
 * External pin 4       = GND
 * External pin 5 (PB0) = Divide 5
...
//      (pin4) DIVD  PB4 3|    |6  PB1 (pin1) DIVB
//                   GND 4|    |5  PB0 (pin0) DIVA
//                        ------
